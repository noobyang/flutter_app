...
object ToastProviderPlugin {
    ...
    /** Channel名称  **/
    public const val ChannelName = "com.lee.flutter_app.plugins/toast"
    ...
    private fun showToast(context: Context, message: String?, duration: Int?) = Toast.makeText(context, message ?: "", duration ?: Toast.LENGTH_SHORT).show()
